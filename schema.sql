...
INSERT OR IGNORE INTO users (username, email, first_name, last_name, role) VALUES ('KModikoane', 'motsomodikoane@gmail.com', 'Kgomotso', 'Modikoane', 'admin');

INSERT INTO users (username, email, first_name, last_name, role) 
VALUES ('Kgothatso@MeetMeat', 'kgomotso.it.modikoane@gmail.com', 'Kgothatso', 'MeetMeat','Executive', 'exec');